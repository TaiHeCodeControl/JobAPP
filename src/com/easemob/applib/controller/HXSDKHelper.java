...
public abstract class HXSDKHelper {
	...
	public synchronized boolean onInit(Context context) {
		...
		// create a defalut HX SDK model in case subclass did not provide the
		// model
		if (hxModel == null) {
	...
	/**
	 * the subclass must override this class to provide its own model or
	 * directly use {@link DefaultHXSDKModel}
	 * 
	 * @return
	 */
