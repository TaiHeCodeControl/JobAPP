...
public class Comment_Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		input_map.put("business_id", business_id);
		input_map.put("personal_id", String.valueOf(personal_id));
		initView();
		get_comment_map=new HashMap<String, String>();
		get_comment_map.put("count", "0");
		get_comment_map.put("business_id", business_id);
	...
	public Handler viewhandler = new Handler() {
		public void handleMessage(Message message) {
			...
			refreshableView.setOnRefreshListener(new CommentPullfreshListener(
					mContext, data_list, comment_Adapter,business_id,"personal"));
	...
	public class GetComment_Task extends AsyncTask<HashMap<String,String>, Void, Boolean> {
		...
		protected void onPostExecute(Boolean result) {
			...
			data_list=parttimeDb.getComments(mContext,business_id,"personal");
			viewhandler.sendEmptyMessage(TYPE_OPERATION);
			return;
		}
